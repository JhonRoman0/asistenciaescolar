...
public class SecurityConfig{
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/reportes/**").hasAnyRole("Administrador", "Secretario")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000","http://192.168.56.102:3000","https://violate-diocese-antelope.ngrok-free.dev","https://shy-perceive-safari.ngrok-free.dev"));
